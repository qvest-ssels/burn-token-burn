...
| Cloud LLM inference energy | **ESTIMATE** ~500 Wh per 1M tokens (accelerator-side): ~0.24 Wh/query (Google, *Measuring the environmental impact of delivering AI products*, 2025) and ~0.3 Wh/query (Epoch AI, 2025, GPT-4o-class) divided by an assumed ~500 output tokens/query. No provider publishes energy per token. Older de Vries (Joule, 2023) ~2.9 Wh/query would be ~6x higher. | see [`CO2_ESTIMATE.md`](CO2_ESTIMATE.md) | 2026-09-15 |
| Hyperscale datacentre PUE | **ESTIMATE** 1.15 — midpoint of the fleet-wide figures the big three publish in their sustainability reports (Google ~1.09, AWS ~1.15, Microsoft ~1.18) | vendor annual sustainability reports; see [`CO2_ESTIMATE.md`](CO2_ESTIMATE.md) | 2026-09-15 |
| US national-average grid carbon intensity | **APPROXIMATE** 390 gCO2/kWh (~0.85 lb/kWh, EPA eGRID-class); not re-verified against the latest eGRID release | see [`CO2_ESTIMATE.md`](CO2_ESTIMATE.md) | 2026-09-15 |
| US gas-heavy datacentre-region grid carbon intensity | **ESTIMATE** 450 gCO2/kWh — representative of a grid where combined-cycle gas (roughly 350–400 gCO2/kWh at the plant) sets most of the marginal generation. Not a published figure for any named balancing authority. | see [`CO2_ESTIMATE.md`](CO2_ESTIMATE.md) | 2026-09-15 |
